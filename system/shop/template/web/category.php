		   ...
		   <div class="form-group">
			   ...
			   <div class="form-group">
			                        ...
			                        <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;">
			                            ...
			                            <img style="width:100%" src="<?php echo ATTACHMENT_WEBROOT;?><?php  echo $category['thumb'];?>" alt="" onerror="$(this).remove();">
			                              <?php  } ?>
			                            </div>
			                        <div>
			                        ...
			                        <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;">
			                            ...
			                            <img style="width:100%" src="<?php echo ATTACHMENT_WEBROOT;?><?php  echo $category['thumbadv'];?>" alt="" onerror="$(this).remove();">
			                              <?php  } ?>
			                            </div>
			                        <div>
