...
<h3 class="header smaller lighter blue">商品评论审核&nbsp;&nbsp;&nbsp;<a  class="btn btn-xs btn-info" href="<?php  echo web_url('goods_comment', array('goodsid' => $shop_goods['id'], 'op' => 'add'))?>" ><i class="icon-edit"></i>&nbsp;添加评论&nbsp;</a></h3>
