...
<h3 class="header smaller lighter blue">商品列表</h3>
	...
	<input type="hidden" name="do" value="goods_window"/>
		...
		<?php if(is_array($list)) { foreach($list as $item) { ?>
				<tr>
				 ...
				 <td><p style="text-align:center"> <img src="<?php echo ATTACHMENT_WEBROOT;?><?php  echo $item['thumb'];?>" height="60" width="60"></p></td>
                                        	...
                                        	<td style="text-align:center;"><?php  echo $item['title'];?>
                                        		<br/>
					...
					<td style="text-align:center;">
					<p ><a class="btn btn-xs btn-info" target="_blank" href="<?php  echo WEBSITE_ROOT;?><?php echo mobile_url('detail',array('name'=>'shopwap','id'=>$item['id']));?>"><i class="icon-eye-open"></i>&nbsp;查&nbsp;看&nbsp;</a>&nbsp;&nbsp;
