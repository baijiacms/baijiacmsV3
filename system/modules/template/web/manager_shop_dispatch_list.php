...
<a href="<?php  echo create_url('site', array('name' => 'modules','do' => 'manager_shop_dispatch','op'=>'post','code'=>$code))?>" class="btn btn-primary">新增配送区域</a>
</div>
