...
<form method="post" class="form-horizontal" enctype="multipart/form-data" >
		<h3 class="header smaller lighter blue">微信自定义回复&nbsp;&nbsp;&nbsp;<a href="<?php  echo create_url('site',  array('name' => 'weixin','do' => 'rule','op'=>'detail','ruletype'=>1))?>" class="btn btn-primary">添加文字回复规则</a>&nbsp;&nbsp;<a href="<?php  echo create_url('site',  array('name' => 'weixin','do' => 'rule','op'=>'detail','ruletype'=>2))?>" class="btn btn-primary">添加图文回复规则</a></h3>
